...
def RetranslateSongNames():
	...
	Styles = [
		...
		StyleClass(StyleTypeValue.Global,_translate("Editor",'Electronic'),0x0659A6EC,'04',[2,22,8,23,62,50]),
		StyleClass(StyleTypeValue.Global,_translate("Editor",'Pop'),0x0659A710,'05',[0,2,13,15,40,47]),
		StyleClass(StyleTypeValue.Global,_translate("Editor",'Japanese'),0x0659A734,'06',[29,noneInstrument,noneInstrument,20,56,51]),
		StyleClass(StyleTypeValue.Global,_translate("Editor",'Tango'),0x0659A758,'07',[25,0,32,16,58,52]),
		StyleClass(StyleTypeValue.Global,_translate("Editor",'Classical'),0x0659A77C,'08',[25,25,6,26,noneInstrument,noneInstrument]),
		StyleClass(StyleTypeValue.Global,_translate("Editor",'Hawaiian'),0x0659A7A0,'09',[17,17,17,16,46,45]),
		StyleClass(StyleTypeValue.Global,_translate("Editor",'Reggae'),0x0659A7C4,'0A',[3,3,0,15,64,noneInstrument]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'Twinkle Twinkle Little Star'),0x0659A7E8,'0B',[0,1,13,16,51,52]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Country'),0x0659A80C,'0C',[33,24,18,16,49,46]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Toy'),0x0659A830,'0D',[36,36,9,36,58,52]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Celtic'),0x0659A854,'0E',[34,34,13,16,59,47]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Folk'),0x0659A878,'0F',[35,32,13,16,59,46]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'O Christmas Tree'),0x0659A89C,'10',[5,5,5,5,51,noneInstrument]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'French Bistro'),0x0659A8C0,'11',[32,30,6,16,53,47]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'Every Breath You Take'),0x0659A8E4,'12',[33,0,22,15,40,47]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Soundtrack'),0x0659A908,'13',[0,13,6,7,58,46]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Soul'),0x0659A92C,'14',[27,28,8,23,40,50]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Eurobeat'),0x0659A950,'15',[36,14,22,23,60,47]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'I'll Be There'),0x0659A974,'16',[38,38,39,39,44,50]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'Woman'),0x0659A998,'17',[28,27,13,15,40,49]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'I've Never Been to Me'),0x0659A9BC,'18',[0,0,13,15,40,46]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'The Legend of Zelda'),0x0659A9E0,'19',[27,25,21,31,58,59]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'Wii Sports'),0x0659AA04,'1A',[29,0,13,15,60,47]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'Animal Crossing'),0x0659AA28,'1B',[32,18,13,13,46,45]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Woodwind'),0x0659AA4C,'1C',[29,30,0,6,noneInstrument,noneInstrument]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'The Entertainer'),0x0659AA70,'1D',[0,6,0,16,42,46]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'Happy Birthday to You'),0x0659AA94,'1E',[27,28,0,16,42,45]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'La Cucaracha'),0x0659AAB8,'1F',[29,1,13,15,48,54]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'From Santurtzi to Bilbao'),0x0659AADC,'20',[3,3,3,3,50,47]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'A Little Night Music'),0x0659AB00,'21',[29,25,6,26,noneInstrument,noneInstrument]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'European'),0x0659AB24,'22',[30,25,4,31,58,52]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'Animal Crossing K. K. Blues'),0x0659AB48,'23',[33,28,13,16,42,53]),
		StyleClass(StyleTypeValue.SongSpecific,_translate("Editor",'Wii Music'),0x0659AB6C,'24',[25,28,0,15,40,50]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Flamenco'),0x0659AB90,'25',[25,25,13,13,52,50]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Karate!'),0x0659ABB4,'26',[14,14,14,15,41,63]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Parade'),0x0659ABD8,'27',[27,30,27,31,65,57]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Exotic'),0x0659ABFC,'28',[19,19,4,19,55,noneInstrument]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'A Cappella'),0x0659AC20,'29',[38,38,39,39,66,50]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Calypso'),0x0659AC44,'2A',[3,3,3,3,noneInstrument,noneInstrument]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Animals!'),0x0659AC68,'2B',[11,11,10,31,59,49]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'NES-Style'),0x0659AC8C,'2C',[37,37,37,37,noneInstrument,noneInstrument]),
		StyleClass(StyleTypeValue.Menu,_translate("Editor",'Menu Style Main'),0x0659ACB0,'2D',[25,28,0,15,40,40]),
		StyleClass(StyleTypeValue.Menu,_translate("Editor",'Menu Style Electronic'),0x0659ACD4,'2E',[2,22,0,23,62,40]),
		StyleClass(StyleTypeValue.Menu,_translate("Editor",'Menu Style Japanese'),0x0659ACF8,'2F',[29,20,0,20,56,40]),
		StyleClass(StyleTypeValue.Menu,_translate("Editor",'Menu Style March'),0x0659AD1C,'30',[30,27,0,31,58,40]),
		StyleClass(StyleTypeValue.Menu,_translate("Editor",'Menu Style A Capella'),0x0659AD40,'31',[38,39,0,39,66,40]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Orchestral'),0x0659AD64,'32',[29,27,25,7,58,noneInstrument]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Ballad'),0x0659AD88,'33',[28,0,0,15,44,45]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'African'),0x0659ADAC,'34',[1,1,1,1,55,45]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Galactic'),0x0659ADD0,'35',[36,22,8,23,60,61]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Hip Hop'),0x0659ADF4,'36',[12,noneInstrument,8,23,62,61]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Samba'),0x0659AE18,'37',[29,1,13,15,65,48]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Acoustic'),0x0659AE3C,'38',[38,18,13,13,45,46]),
		StyleClass(StyleTypeValue.Unused,_translate("Editor",'Unused 1'),0x0659AE60,'39',[28,29,28,31,noneInstrument,noneInstrument]),
		StyleClass(StyleTypeValue.Unused,_translate("Editor",'Unused 2'),0x0659AE84,'3A',[31,27,29,29,noneInstrument,noneInstrument]),
		StyleClass(StyleTypeValue.Unused,_translate("Editor",'Unused 3'),0x0659AEA8,'3B',[8,8,8,8,noneInstrument,noneInstrument]),
		StyleClass(StyleTypeValue.Unused,_translate("Editor",'Unused 4'),0x0659AECC,'3C',[1,1,1,1,62,54]),
		StyleClass(StyleTypeValue.Unused,_translate("Editor",'Unused 5'),0x0659AEF0,'3D',[26,0,29,16,noneInstrument,noneInstrument]),
		StyleClass(StyleTypeValue.Unused,_translate("Editor",'Unused 6'),0x0659AF14,'3E',[26,0,29,16,noneInstrument,noneInstrument]),
		StyleClass(StyleTypeValue.Unused,_translate("Editor",'Unused 7'),0x0659AF38,'3F',[26,26,31,26,noneInstrument,noneInstrument]),
		StyleClass(StyleTypeValue.Unused,_translate("Editor",'Unused 8'),0x0659AF5C,'40',[8,8,8,8,noneInstrument,noneInstrument]),
		StyleClass(StyleTypeValue.Unused,_translate("Editor",'Unused 9'),0x0659AF80,'41',[1,1,1,1,62,54]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Salsa'),0x0659AFA4,'42',[27,1,13,15,45,54]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Handbells'),0x0659AFC8,'43',[5,5,5,5,51,noneInstrument]),
		StyleClass(StyleTypeValue.QuickJam,_translate("Editor",'Funk'),0x0659AFEC,'44',[27,28,22,15,40,50]),
		StyleClass(StyleTypeValue.Unused,_translate("Editor",'Unused 10'),0x0659B010,'45',[27,25,21,31,59,47])]
